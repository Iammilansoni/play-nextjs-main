        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              "MiningNiti delivers cutting-edge digital solutions for the mining industry, optimizing data management and boosting operational efficiency with advanced technology."              </p>
