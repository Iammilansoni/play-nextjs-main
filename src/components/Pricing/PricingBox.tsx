...
const MiningNitiPricingBox = ({ product }: { product: Price }) => {
  // POST request
      ...
      >
        ...
        <div className="mb-[50px]">
          ...
          <div className="mb-10">
            ...
            {/* MiningNiti Specific Features */}
            <OfferList text="Real-time data mining and processing" />
            <OfferList text="AI-driven insights for decision-making" />
            <OfferList text="Seamless integration with existing data systems" />
            <OfferList text="Advanced data security and access controls" />
            <OfferList text="Customizable reporting and analytics tools" />
            <OfferList text="Cloud-based access with 24/7 uptime" />
          </div>
        </div>
...
export default MiningNitiPricingBox;
